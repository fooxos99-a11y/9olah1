  ...
  async function fetchStatistics() {
    ...
    try {
      ...
      const [studentsResult, circlesResult, plansResult] = await Promise.all([
        ...
        supabase.from("student_plans").select("student_id, daily_pages, muraajaa_pages, rabt_pages"),
      ]);
      ...
      const studyDayCount = dateFilter === "all" ? countStudyDaysInRange(new Date(2020, 0, 1), end) : countStudyDaysInRange(start, end);
